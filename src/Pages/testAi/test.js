      ...
      <div className='container'>
        <div className='row'>
          <div className='column'>
            <h1 hidden={true}>Galleon PFP Generator</h1>
            <p hidden={true}>Customize and mint your own cyber pirate 🏴‍☠️</p>
            <div className="preferences">
              <p hidden={true}>Style: {userPreferences.style > 50 ? 'Pirate 🏴‍☠️' : 'Cyber 🦾'}</p>
              <input
                hidden={true}
                type="range"
                min="0"
              ...
              />
              <p hidden={true}>Equipment: {userPreferences.equipment > 50 ? 'High tech 🎚️' : 'Low tech 🔧'}</p>
              <input
                hidden={true}
                type="range"
                min="0"
              ...
              />
              <p hidden={true}>Gender: {userPreferences.gender > 50 ? 'Female ♀' : 'Male ⚦'}</p>
              <input
                hidden={true}
                type="range"
                min="0"
